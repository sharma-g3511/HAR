...
from tensorflow.keras import layers, optimizers, backend, utils, callbacks, Model
...
x = layers.Conv1D(32,5,activation='selu',padding='same', kernel_initializer='he_normal', data_format = 'channels_first')(input)
x = layers.MaxPooling1D(pool_size=5,strides=2,padding='same')(x)
...
# np.savetxt('a_1d.csv', score_val ,  delimiter=',', fmt ='% s')
